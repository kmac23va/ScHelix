    ...
    function(Sitecore, ExperienceEditor) {
        ...
        Sitecore.Commands.ShowRenderingChrome =
        {
            ...
            canExecute: function(context) {
                ...
                ExperienceEditor.Common.registerDocumentStyles(["/Assets/Foundation/css/sitecore/RenderingChrome/chrome-styles.css"], window.parent.document);
            ...
            execute: function(context) {
                ExperienceEditor.PipelinesUtil.generateRequestProcessor("ExperienceEditor.ToggleRegistryKey.Toggle",
                    function(response) {
